...
class PointNetModel(BaseSegmentationModel):

    def __init__(self, checkpoint, pointnet_root, device="auto"):
    ...
    def load(self):
        ...
        sys.path.insert(
            0,
            os.path.join(self.pointnet_root, "models")
        )
