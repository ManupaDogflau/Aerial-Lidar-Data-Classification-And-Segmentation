...
\title{AERIAL LIDAR DATA CLASSIFICATION AND
SEGMENTATION}   		           % Master thesis title
\author{Manuel Pablo González Calzón}    % Name and surnames of the student
\supervisor{Isaac Segovia Ramírez} % Name and surnames of the director/advisor
\ponente{Ángel de Castro Martín}   % Name and surnames of the ponente/lecturer (only if applicable)
\date{June 2026}

\begin{document}
\maketitle                          % Generate frontpage
\include{0.Abstract}	                % Abstract and 
...
\include{1.Introduction}			% incluir capítulo de introduccion/introduction
\include{2.RelatedWork}			% incluir capítulo de estado del arte/state-of-art
\include{3.Design}                  % incluir capítulo de diseño-y-desarrollo/design-and-development
\include{4.Evaluation}              % incluir capítulo de evaluacion/evaluation
\include{5.Conclusions}            % incluir capítulo de conclusiones/conclusions
